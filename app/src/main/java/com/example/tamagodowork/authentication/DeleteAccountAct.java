            ...
            FirebaseAuth.getInstance().getCurrentUser().delete().addOnCompleteListener(new OnCompleteListener<Void>() {
                ...
                public void onComplete(@NonNull @NotNull Task<Void> task) {
                        if (task.isSuccessful()) {
                            ...
                            toDoes.get().addOnSuccessListener(queryDocumentSnapshots -> queryDocumentSnapshots.getDocuments().forEach(documentSnapshot -> documentSnapshot.getReference().delete()));


                            pet.get().addOnSuccessListener(
                                    queryDocumentSnapshots -> queryDocumentSnapshots.getDocuments().forEach(documentSnapshot -> documentSnapshot.getReference().delete())
                            );
                            ...
                            Toast.makeText(DeleteAccountAct.this, task.getException().getMessage(), Toast.LENGTH_SHORT).show();
                        }
                    }
                }
            ));
